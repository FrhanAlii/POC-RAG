 ...
 * Domain: amazon
 * Feature: auto_fixed_1770896185780
 * Learned At: 2026-02-12T11:37:24.349Z
 */
import { test, expect } from '@playwright/test';

// GENERATED_BY_REAL_LLM
// MODEL: gpt-4o-mini
// TIMESTAMP: 2026-02-12T11:36:37.313Z
...
test('Search and add to cart', async ({ page }) => {
    ...
    if (!clicked) {
        ...
        const textBtn = page.getByRole('button', { name: 'Add to cart' }).first();
